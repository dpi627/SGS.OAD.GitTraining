...
![bg 80%](../asset/lims-usecase-sync-main.svg)
...
![bg 90%](../asset/lims-usecase-related-feature.svg)

---

![bg 90%](../asset/lims-usecase-urgent-issue.svg)
...
![bg right:45% fit](../asset/aftervc.png)
...
>💡若發生衝突，可找開發者一起討論，避免衍生更多衝突(物理) 😆

---

![bg left:17%](https://picsum.photos/1080?image=1080)

# 🔎資料**查詢**

||![h:100](../asset/sourcetree.png)|![h:100](../asset/gitea.png)|![h:100](../asset/tortoise.png)|![h:100](../asset/file-explorer.png)|
|-|-|-|-|-|
|**使用體驗**|⭐|⭐⭐|⭐⭐⭐|⭐|
|**查詢速度**|⭐|⭐⭐|⭐⭐⭐|⭐|
|**查詢範圍**|⭐⭐|⭐⭐⭐|⭐⭐⭐|⭐|
|**介面設計**|⭐⭐⭐|⭐⭐|⭐|⭐|
|**補充說明**|使用體驗差|離線無法使用|需額外安裝|無法查紀錄

>💡建議安裝 [Tortoise**Git**](https://tortoisegit.org/)，其 `檔案狀態標註` 與 `合併工具` 都很實用
...
>已知主機 `twvoadtpw100004` 狀況，之前使用 `twoadcode` 時均無遇到，目前無解

- ❓與遠端進行**驗證**時，偶爾會異常
  💡`push` 與 `pull` 時偶爾會失敗，一次不行就跑兩次，通常第二次都會成功

- ❓Email **通知功能**無法使用
  💡`Gitea` 完成特定操作後會發送 Email，設定公司信箱無效，暫以 `TEAMS` 通知取代

---

<!-- _class: invert -->

![bg left:40%](https://picsum.photos/1080?image=1041)
